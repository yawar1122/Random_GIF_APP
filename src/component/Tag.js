...
function Tag() {
  ...
  return (
    <div className="w-3/6 h-[450px] mt-5 bg-blue-400 mt-6 rounded-lg flex flex-col items-center justify-between py-4 px-5">
      ...
      <input
        ...
        type='text'
        className='w-full text-center text-lg py-2 rounded-lg mb-2'
        value={tag}
